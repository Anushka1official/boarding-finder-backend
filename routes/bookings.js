...
// GET my bookings — student sees their own bookings (must be before /:id)
...
// GET bookings for landlord — owner sees all bookings on their listings (must be before /:id)
